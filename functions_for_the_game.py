...
def createClass():
    ...
    if c == 1:
        # Archer Path
        typing("I figured you'd choose magic like everyone else... Arrows are for pompous assho***")
        time.sleep(1)
        typing("though who am I to judge?")
        heroRanged = 15
        heroMagic = 10
    elif c == 2:
        typing("I thought you'd choose arrows... You only chose Magic because it looks cooler in the movies...")
        time.sleep(1)
        typing("Eh, who am I to judge?")
        heroRanged = 10
        heroMagic = 15
